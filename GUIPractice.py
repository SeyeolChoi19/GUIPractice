...
class GUIPractice:
    ...
    def create_initial_state(self):
        ...
        self.join_type_box   = create_combobox(0.05, 0.19, "join_type")
        self.join_column_box = create_combobox(0.15, 0.19, "join_variable")
        create_button("Merge Datasets", merge_data, 0.05, 0.23, button_width = 57)
        
        create_label("3. Data Transformation", 0.05, 0.29)    
        self.select_filter_variable  = create_combobox(0.05, 0.33, "filter_variable")
        self.select_filter_operation = create_combobox(0.15, 0.33, "filter_operation")
        self.filter_value_text_box   = create_text_bar(1, 0, 0, 0.25, 0.33, 106, state = "normal")
        create_button("Apply Transformation", apply_transformation, 0.05, 0.37, button_width = 57)
        ...
        create_label("6. Descriptive Statistics (for numeric columns)", 0.05, 0.75)
        create_label("Select variables", 0.05, 0.79)
        create_label("Mean", 0.145, 0.79)
        create_label("Median", 0.205, 0.79)
        create_label("Mode", 0.265, 0.79)
        create_button("Generate Stats", generate_stats, 0.05, 0.87, button_width = 57)
        self.select_numerical_variables = create_combobox(0.05, 0.83, "descriptive_stats_box")
        self.mean_text_bar              = create_text_bar(1, 0, 0, 0.145, 0.83, 80, state = "normal")
